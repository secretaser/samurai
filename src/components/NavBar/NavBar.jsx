   ...
   return (
      <div className={style.container}>
         <nav className={style.navigation}>
            <div className={style.navigation__item}><NavLink to="/profile" className={navData => navData.isActive ? style.activeLink : style.navigation__link}>My profile</NavLink></div>
